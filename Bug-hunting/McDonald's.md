...
ajdev@rootbox:~$ ffuf -u "https://delivery.mcdonalds.com/FUZZ" -w /usr/share/seclists/Discovery/Web-Content/raft-large-directories-lowercase.txt
...
GET /api/user/profile-preferences HTTP/1.1
Host: admin.me.mcd.com

GET /api/currentUser HTTP/2
Host: admin.me.mcd.com
|
HTTP/2 401 Unauthorized
{"Error":"Not logged in"}

GET /auth/login?return=/ HTTP/2
Host: admin.me.mcd.com
|
HTTP/2 302 Found
Redirecting to somthing
