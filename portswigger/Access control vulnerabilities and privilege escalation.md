...
first analysis how the system works. Then i want to update the same by using the unauthorized user, to do it first i try by post request but it show unauthorized then i change request method.
